                      ...
                      <td className="flex items-center gap-2">
                        {product.images.map((img) => (
                          <Image
                            key={img}
                            src={
                              "https://tjnkjlpbumtqlylftrkn.supabase.co/storage/v1/object/public/" +
                              img
                            }
                            alt=""
                            className="hover:scale-125 duration-200 rounded-sm"
                            width={40}
                            height={40}
                          />
                        ))}
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-1">
              {images.map((img, index) => (
                <div key={img} className="relative w-[128px] h-[128px]">
                  <Image
